...
public:
	...
	friend Array <Complex> fft (Array <Complex> & originalArray);
	friend Array <Complex> _fft (Array <Complex> & originalArray);
	friend Array <Complex> ifft (Array <Complex> & originalArray);
	friend Array <Complex> _ifft (Array <Complex> & originalArray);
